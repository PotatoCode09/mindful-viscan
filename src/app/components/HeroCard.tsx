...
const HeroCard = () => {
  return (
    <div className="flex min-h-screen items-center justify-center p-4 md:p-6">
      ...
      <div className="relative flex flex-col mx-auto rounded-2xl bg-[#031207] p-8 md:p-16 border border--900/50 shadow-[4px_4px_0px_0px_rgba(34,197,94,0.15)] w-full max-md:min-w-0 md:min-w-325 md:min-h-175">
